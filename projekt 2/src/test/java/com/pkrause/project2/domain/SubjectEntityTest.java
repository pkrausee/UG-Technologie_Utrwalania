...
public class SubjectEntityTest {
    ...
    @Autowired
    public SubjectEntityTest(GradeRepository gradeRepository, StudentRepository studentRepository, SubjectRepository subjectRepository) {
    ...
    public void GivenGetGrades_WhenThereAreTwoGrades_ReturnsListWithTwoGrades() {
        ...
        subjectEntity = this.subjectRepository.findById(subjectEntity.getId()).orElse(null);

        assertEquals(2, subjectEntity.getGrades().size());
    }
}
